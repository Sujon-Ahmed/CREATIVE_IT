...
$after_assoc2 = mysqli_fetch_assoc($select_banner_result);
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="banner_edit_action.php" method="POST" enctype="multipart/form-data">
                                ...
                                <input type="text" name="sub_title" value="<?= $after_assoc2['banner_sub_title'] ?>" id="" class="form-control" placeholder="Enter your banner sub title">
                                <!-- title felid -->
                                <label for="title" class="mt-2">Title</label> <br>
                                <input type="text" name="title" value="<?= $after_assoc2['banner_title'] ?>" id="" class="form-control" placeholder="Enter your banner title">
                                <!-- image felid -->
                                <label for="file" class="mt-2">Banner Image</label>
                                <input type="hidden" name="old_file" value="<?= $after_assoc2['banner_image'] ?>" id="" class="form-control">
                                <input type="file" name="file" id="" class="form-control">
                                <!-- title felid -->
                                <label for="description" class="mt-2">Description</label> <br>
                                <textarea name="description" id="summernote" cols="30" rows="5" class="form-control"><?= $after_assoc2['banner_description'] ?></textarea>
                                <!-- submit button -->
                                <div class="mt-3 d-grid gap-2 col-6 mx-auto py-2">
                                    <input type="hidden" name="id" value="<?= $after_assoc2['id'] ?>" id="">
